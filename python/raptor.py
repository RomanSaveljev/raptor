...
class BuildRecord(object):
	...
	@classmethod
	def from_old(cls, adir, commandline, topmakefile, configlist, metadepsfilename):
...
class Raptor(object):
	...
	def _default_setup(self, home = None):
		...
		self.incremental_metadata = False
	...
	def SetIncremental(self, flag):
		self.incremental_metadata = flag
		return  True
