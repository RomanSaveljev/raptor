...
export TALON_SHELL_CL_MAX

define startrule
	@|RECIPE=$1;TARGET=$$@;COMPONENT_LAYER=$(COMPONENT_LAYER);COMPONENT_NAME=$(COMPONENT_NAME);COMPONENT_META=$(COMPONENT_META);PROJECT_META=$(PROJECT_META);SBS_CONFIGURATION=$(SBS_CONFIGURATION);PLATFORM=$(PLATFORM);MAKEFILE_GROUP=$(MAKEFILE_GROUP);SOURCE=$3;TALON_FLAGS=$2;$(if $(SHELL_CL_MAX),TALON_SHELL_CL_MAX=$(SHELL_CL_MAX);)$(if $(FLMDEBUG),RECIPE_PREREQS=$$^;,)|
endef
