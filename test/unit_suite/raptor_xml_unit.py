...
class TestRaptorXML(unittest.TestCase):
	...
	def testSystemDefinitionWriting(self):
		...
		model.AddComponent(raptor.BldinfComponent(bldinf1,'layer1'))
		model.AddComponent(raptor.BldinfComponent(bldinf2,'layer1'))
		model.AddComponent(raptor.BldinfComponent(bldinf3,'layer2'))
